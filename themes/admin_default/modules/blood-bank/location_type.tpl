...
<div class="panel panel-default">
	<div class="panel-body">
		<form class="form-horizontal" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}" method="post">
			...
			<div class="form-group">
				<label class="col-sm-4 control-label"><strong>{LANG.note}</strong></label>
				<div class="col-sm-20">
...
<script type="text/javascript">
	...
	function nv_change_status(id) {
		...
		if (confirm(nv_is_change_act_confirm[0])) {
			...
			$.post(script_name + '?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=location_type&nocache=' + new Date().getTime(), 'change_status=1&id=' + id, function(res) {
